...
impl From<Statement> for df_sqlparser::ast::Statement {
    fn from(value: Statement) -> Self {
        match value {
            Statement::Analyze {
                ...
                table_name: Convert::convert(table_name),
                partitions: Convert::convert_option_vec(partitions),
                for_columns: Convert::convert(for_columns),
                columns: Convert::convert_vec(columns),
                cache_metadata: Convert::convert(cache_metadata),
                noscan: Convert::convert(noscan),
                compute_statistics: Convert::convert(compute_statistics),
            },
            Statement::Truncate {
                table_name,
                partitions,
            ...
            Statement::Msck {
                ...
                table_name: Convert::convert(table_name),
                repair: Convert::convert(repair),
                partition_action: Convert::convert_option(partition_action),
            },
            Statement::Query(a) => Self::Query(Convert::convert_box(a)),
            Statement::Insert {
                or,
                into,
                table_name,
                ...
                or: Convert::convert_option(or),
                into: Convert::convert(into),
                table_name: Convert::convert(table_name),
                columns: Convert::convert_vec(columns),
                overwrite: Convert::convert(overwrite),
                source: Convert::convert_box(source),
                partitioned: Convert::convert_option_vec(partitioned),
                after_columns: Convert::convert_vec(after_columns),
                table: Convert::convert(table),
                on: Convert::convert_option(on),
                returning: Convert::convert_option_vec(returning),
            },
            Statement::Directory {
                overwrite,
                local,
                ...
                overwrite: Convert::convert(overwrite),
                local: Convert::convert(local),
                path: Convert::convert(path),
                file_format: Convert::convert_option(file_format),
                source: Convert::convert_box(source),
            },
            Statement::Copy {
                source,
                ...
                source: Convert::convert(source),
                to: Convert::convert(to),
                target: Convert::convert(target),
                options: Convert::convert_vec(options),
                legacy_options: Convert::convert_vec(legacy_options),
                values: Convert::convert_vec(values),
            },
            Statement::CopyIntoSnowflake {
                ...
                into: Convert::convert(into),
                from_stage: Convert::convert(from_stage),
                from_stage_alias: Convert::convert_option(from_stage_alias),
                stage_params: Convert::convert(stage_params),
                from_transformations: Convert::convert_option_vec(from_transformations),
                files: Convert::convert_option_vec(files),
                pattern: Convert::convert_option(pattern),
                file_format: Convert::convert(file_format),
                copy_options: Convert::convert(copy_options),
                validation_mode: Convert::convert_option(validation_mode),
            },
            Statement::Close { cursor } => Self::Close {
                cursor: Convert::convert(cursor),
            },
            Statement::Update {
                table,
                assignments,
                ...
                table: Convert::convert(table),
                assignments: Convert::convert_vec(assignments),
                from: Convert::convert_option(from),
                selection: Convert::convert_option(selection),
                returning: Convert::convert_option_vec(returning),
            },
            Statement::Delete {
                tables,
                ...
                tables: Convert::convert_vec(tables),
                from: Convert::convert_vec(from),
                using: Convert::convert_option_vec(using),
                selection: Convert::convert_option(selection),
                returning: Convert::convert_option_vec(returning),
            },
            Statement::CreateView {
                ...
                or_replace: Convert::convert(or_replace),
                materialized: Convert::convert(materialized),
                name: Convert::convert(name),
                columns: Convert::convert_vec(columns),
                query: Convert::convert_box(query),
                with_options: Convert::convert_vec(with_options),
                cluster_by: Convert::convert_vec(cluster_by),
            },
            Statement::CreateTable {
                ...
                or_replace: Convert::convert(or_replace),
                temporary: Convert::convert(temporary),
                external: Convert::convert(external),
                global: Convert::convert_option(global),
                if_not_exists: Convert::convert(if_not_exists),
                transient: Convert::convert(transient),
                name: Convert::convert(name),
                columns: Convert::convert_vec(columns),
                constraints: Convert::convert_vec(constraints),
                hive_distribution: Convert::convert(hive_distribution),
                hive_formats: Convert::convert_option(hive_formats),
                table_properties: Convert::convert_vec(table_properties),
                with_options: Convert::convert_vec(with_options),
                file_format: Convert::convert_option(file_format),
                location: Convert::convert_option(location),
                query: Convert::convert_option_box(query),
                without_rowid: Convert::convert(without_rowid),
                like: Convert::convert_option(like),
                clone: Convert::convert_option(clone),
                engine: Convert::convert_option(engine),
                default_charset: Convert::convert_option(default_charset),
                collation: Convert::convert_option(collation),
                on_commit: Convert::convert_option(on_commit),
                on_cluster: Convert::convert_option(on_cluster),
                order_by: Convert::convert_option_vec(order_by),
                strict: false,
            },
            Statement::CreateVirtualTable {
                ...
                name: Convert::convert(name),
                if_not_exists: Convert::convert(if_not_exists),
                module_name: Convert::convert(module_name),
                module_args: Convert::convert_vec(module_args),
            },
            Statement::CreateIndex {
                ...
                name: Convert::convert(name),
                table_name: Convert::convert(table_name),
                using: Convert::convert_option(using),
                columns: Convert::convert_vec(columns),
                unique: Convert::convert(unique),
                if_not_exists: Convert::convert(if_not_exists),
            },
            Statement::CreateRole {
                ...
                names: Convert::convert_vec(names),
                if_not_exists: Convert::convert(if_not_exists),
                login: Convert::convert_option(login),
                inherit: Convert::convert_option(inherit),
                bypassrls: Convert::convert_option(bypassrls),
                password: Convert::convert_option(password),
                superuser: Convert::convert_option(superuser),
                create_db: Convert::convert_option(create_db),
                create_role: Convert::convert_option(create_role),
                replication: Convert::convert_option(replication),
                connection_limit: Convert::convert_option(connection_limit),
                valid_until: Convert::convert_option(valid_until),
                in_role: Convert::convert_vec(in_role),
                in_group: Convert::convert_vec(in_group),
                role: Convert::convert_vec(role),
                user: Convert::convert_vec(user),
                admin: Convert::convert_vec(admin),
                authorization_owner: Convert::convert_option(authorization_owner),
            },
            Statement::AlterTable { name, operation } => Self::AlterTable {
                name: Convert::convert(name),
                operation: Convert::convert(operation),
            },
            Statement::AlterIndex { name, operation } => Self::AlterIndex {
                name: Convert::convert(name),
                operation: Convert::convert(operation),
            },
            Statement::Drop {
                ...
                object_type: Convert::convert(object_type),
                if_exists: Convert::convert(if_exists),
                names: Convert::convert_vec(names),
                cascade: Convert::convert(cascade),
                restrict: Convert::convert(restrict),
                purge: Convert::convert(purge),
            },
            Statement::DropFunction {
                ...
                if_exists: Convert::convert(if_exists),
                func_desc: Convert::convert_vec(func_desc),
                option: Convert::convert_option(option),
            },
            Statement::Declare {
                name,
                binary,
                ...
                name: Convert::convert(name),
                binary: Convert::convert(binary),
                sensitive: Convert::convert_option(sensitive),
                scroll: Convert::convert_option(scroll),
                hold: Convert::convert_option(hold),
                query: Convert::convert_box(query),
            },
            Statement::Fetch {
                name,
                ...
                name: Convert::convert(name),
                direction: Convert::convert(direction),
                into: Convert::convert_option(into),
            },
            Statement::Discard { object_type } => Self::Discard {
                object_type: Convert::convert(object_type),
            },
            Statement::SetRole {
                context_modifier,
                ...
                context_modifier: Convert::convert(context_modifier),
                role_name: Convert::convert_option(role_name),
            },
            Statement::SetVariable {
                ...
                local: Convert::convert(local),
                hivevar: Convert::convert(hivevar),
                variable: Convert::convert(variable),
                value: Convert::convert_vec(value),
            },
            Statement::SetTimeZone { local, value } => Self::SetTimeZone {
                local: Convert::convert(local),
            ...
            Statement::SetNames {
                ...
                charset_name: Convert::convert(charset_name),
                collation_name: Convert::convert_option(collation_name),
            },
            Statement::SetNamesDefault {} => Self::SetNamesDefault {},
            Statement::ShowFunctions { filter } => Self::ShowFunctions {
                filter: Convert::convert_option(filter),
            },
            Statement::ShowVariable { variable } => Self::ShowVariable {
                variable: Convert::convert_vec(variable),
            },
            Statement::ShowVariables { filter } => Self::ShowVariables {
                filter: Convert::convert_option(filter),
            },
            Statement::ShowCreate { obj_type, obj_name } => Self::ShowCreate {
                obj_type: Convert::convert(obj_type),
                obj_name: Convert::convert(obj_name),
            },
            Statement::ShowColumns {
                ...
                extended: Convert::convert(extended),
                full: Convert::convert(full),
                table_name: Convert::convert(table_name),
                filter: Convert::convert_option(filter),
            },
            Statement::ShowTables {
                ...
                extended: Convert::convert(extended),
                full: Convert::convert(full),
                db_name: Convert::convert_option(db_name),
                filter: Convert::convert_option(filter),
            },
            Statement::ShowCollation { filter } => Self::ShowCollation {
                filter: Convert::convert_option(filter),
            },
            Statement::Use { db_name } => Self::Use {
                db_name: Convert::convert(db_name),
            },
            Statement::StartTransaction { modes } => Self::StartTransaction {
                modes: Convert::convert_vec(modes),
            },
            Statement::SetTransaction {
                ...
                modes: Convert::convert_vec(modes),
                snapshot: Convert::convert_option(snapshot),
                session: Convert::convert(session),
            },
            Statement::Comment {
                object_type,
                object_name,
                ...
                object_type: Convert::convert(object_type),
                object_name: Convert::convert(object_name),
                comment: Convert::convert_option(comment),
                if_exists: Convert::convert(if_exists),
            },
            Statement::Commit { chain } => Self::Commit {
                chain: Convert::convert(chain),
            },
            Statement::Rollback { chain } => Self::Rollback {
                chain: Convert::convert(chain),
            },
            Statement::CreateSchema {
                ...
                schema_name: Convert::convert(schema_name),
                if_not_exists: Convert::convert(if_not_exists),
            },
            Statement::CreateDatabase {
                ...
                if_not_exists: Convert::convert(if_not_exists),
                location: Convert::convert_option(location),
                managed_location: Convert::convert_option(managed_location),
            },
            Statement::CreateFunction {
                ...
                temporary: Convert::convert(temporary),
                name: Convert::convert(name),
                args: Convert::convert_option_vec(args),
                return_type: Convert::convert_option(return_type),
                params: Convert::convert(params),
            },
            Statement::CreateStage {
                ...
                name: Convert::convert(name),
                stage_params: Convert::convert(stage_params),
                directory_table_params: Convert::convert(directory_table_params),
                file_format: Convert::convert(file_format),
                copy_options: Convert::convert(copy_options),
                comment: Convert::convert_option(comment),
            },
            Statement::Assert { condition, message } => Self::Assert {
                condition: Convert::convert(condition),
                message: Convert::convert_option(message),
            },
            Statement::Grant {
                privileges,
                objects,
                ...
                privileges: Convert::convert(privileges),
                objects: Convert::convert(objects),
                grantees: Convert::convert_vec(grantees),
                with_grant_option: Convert::convert(with_grant_option),
                granted_by: Convert::convert_option(granted_by),
            },
            Statement::Revoke {
                privileges,
                objects,
            ...
            Statement::Deallocate { name, prepare } => Self::Deallocate {
                name: Convert::convert(name),
                prepare: Convert::convert(prepare),
            },
            Statement::Execute { name, parameters } => Self::Execute {
                name: Convert::convert(name),
                parameters: Convert::convert_vec(parameters),
            },
            Statement::Prepare {
                name,
                data_types,
                ...
                name: Convert::convert(name),
                data_types: Convert::convert_vec(data_types),
                statement: Convert::convert_box(statement),
            },
            Statement::Kill { modifier, id } => Self::Kill {
                modifier: Convert::convert_option(modifier),
                id: Convert::convert(id),
            },
            Statement::ExplainTable {
                describe_alias,
                table_name,
            } => Self::ExplainTable {
                describe_alias: Convert::convert(describe_alias),
                table_name: Convert::convert(table_name),
            },
            Statement::Explain {
                describe_alias,
                ...
                describe_alias: Convert::convert(describe_alias),
                analyze: Convert::convert(analyze),
                verbose: Convert::convert(verbose),
                statement: Convert::convert_box(statement),
                format: Convert::convert_option(format),
            },
            Statement::Savepoint { name } => Self::Savepoint {
                name: Convert::convert(name),
            },
            Statement::Merge {
                into,
                ...
                table: Convert::convert(table),
                source: Convert::convert(source),
                on: Convert::convert_box(on),
                clauses: Convert::convert_vec(clauses),
            },
            Statement::Cache {
                table_flag,
                table_name,
                ...
                table_flag: Convert::convert_option(table_flag),
                table_name: Convert::convert(table_name),
                has_as: Convert::convert(has_as),
                options: Convert::convert_vec(options),
                query: Convert::convert_option(query),
            },
            Statement::UNCache {
                table_name,
                if_exists,
            ...
            Statement::CreateSequence {
                ...
                if_not_exists: Convert::convert(if_not_exists),
                name: Convert::convert(name),
                data_type: Convert::convert_option(data_type),
                sequence_options: Convert::convert_vec(sequence_options),
                owned_by: Convert::convert_option(owned_by),
            },
            Statement::CreateType { .. } => {
                panic!("Convert on this item is ignored")
            }
        }
    }
}
